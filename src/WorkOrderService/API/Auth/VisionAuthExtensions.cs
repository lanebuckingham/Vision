...
public static class VisionAuthExtensions
{
    ...
    {
        public const string WorkOrderManager = "WorkOrderManager";
        public const string TechnicianWork = "TechnicianWork";
    }
        ...
        IWebHostEnvironment environment)
    {
        ...
        services.AddAuthorizationBuilder()
            .AddPolicy(Policies.WorkOrderManager, policy =>
                policy.RequireAuthenticatedUser()
                      .RequireAssertion(ctx => HasGroup(ctx.User, "SecurityManager")))
            .AddPolicy(Policies.TechnicianWork, policy =>
                policy.RequireAuthenticatedUser()
                      .RequireAssertion(ctx => HasGroup(ctx.User, "Technician")));
