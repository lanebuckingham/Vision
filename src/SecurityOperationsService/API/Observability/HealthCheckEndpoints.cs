...
///   /health/live  — is the process alive? Never touches PostgreSQL/SQS. A temporary
...
public static class HealthCheckEndpoints
{
    public static WebApplication MapVisionHealthEndpoints(this WebApplication app, string serviceName)
    {
        ...
        // Compatibility alias for existing local tooling/docs. Do not add new checks here.
    ...
    private static Task WriteResponse(HttpContext context, HealthReport report)
    {
        ...
        // Intentionally minimal: status + component name only. Never surface exception
        // details, connection strings, or other configuration through this endpoint.
        var payload = new
        {
