...
/// <summary>
/// Registers OpenTelemetry tracing and trace-correlated logging for CredentialService.
/// CredentialService has no asynchronous messaging (per architecture rules), so unlike
/// SecurityOperationsService/WorkOrderService there is no custom ActivitySource here —
/// automatic ASP.NET Core/HttpClient/Npgsql instrumentation covers every boundary this
/// service has.
/// </summary>
public static class VisionObservabilityExtensions
{
    public const string ServiceName = "vision-credential-service";
