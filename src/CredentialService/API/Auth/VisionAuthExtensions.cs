...
namespace Vision.CredentialService.API.Auth;
...
public static class VisionAuthExtensions
{
    ...
    {
        public const string CredentialAdmin = "CredentialAdmin";
    }
        ...
        IWebHostEnvironment environment)
    {
        ...
        services.AddAuthorizationBuilder()
            .AddPolicy(Policies.CredentialAdmin, policy =>
                policy.RequireAuthenticatedUser()
                      .RequireAssertion(ctx =>
                          HasGroup(ctx.User, "SecurityManager") ||
                          HasGroup(ctx.User, "CredentialAdministrator")));
